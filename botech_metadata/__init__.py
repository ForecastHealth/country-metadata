...
_records = [
    ...
    Country("Bolivia, Plurinational State of", "BO", "BOL", "068", "Bolivia, Plurinational State of"),
    Country("Bonaire, Sint Eustatius and Saba", "BQ", "BES", "535", "Bonaire, Sint Eustatius and Saba"),
    ...
    Country("British Indian Ocean Territory", "IO", "IOT", "086", "British Indian Ocean Territory"),
    ...
    Country("Congo, Democratic Republic of the", "CD", "COD", "180", "Congo, Democratic Republic of the"),
    ...
    Country("Falkland Islands (Malvinas)", "FK", "FLK", "238", "Falkland Islands (Malvinas)"),
    ...
    Country("French Southern Territories", "TF", "ATF", "260", "French Southern Territories"),
    ...
    Country("Heard Island and McDonald Islands", "HM", "HMD", "334", "Heard Island and McDonald Islands"),
    ...
    Country("Iran, Islamic Republic of", "IR", "IRN", "364", "Iran, Islamic Republic of"),
    ...
    Country("Korea, Democratic People's Republic of", "KP", "PRK", "408", "Korea, Democratic People's Republic of"),
    ...
    Country("Lao People's Democratic Republic", "LA", "LAO", "418", "Lao People's Democratic Republic"),
    ...
    Country("Micronesia, Federated States of", "FM", "FSM", "583", "Micronesia, Federated States of"),
    ...
    Country("Saint Helena, Ascension and Tristan da Cunha", "SH", "SHN", "654", "Saint Helena, Ascension and Tristan da Cunha"),
    Country("Saint Kitts and Nevis", "KN", "KNA", "659", "Saint Kitts and Nevis"),
    Country("Saint Lucia", "LC", "LCA", "662", "Saint Lucia"),
    Country("Saint Martin (French part)", "MF", "MAF", "663", "Saint Martin (French part)"),
    Country("Saint Pierre and Miquelon", "PM", "SPM", "666", "Saint Pierre and Miquelon"),
    Country("Saint Vincent and the Grenadines", "VC", "VCT", "670", "Saint Vincent and the Grenadines"),
    ...
    Country("Sint Maarten (Dutch part)", "SX", "SXM", "534", "Sint Maarten (Dutch part)"),
    ...
    Country("South Georgia and the South Sandwich Islands", "GS", "SGS", "239", "South Georgia and the South Sandwich Islands"),
    ...
    Country("Tanzania, United Republic of", "TZ", "TZA", "834", "Tanzania, United Republic of"),
    ...
    Country("United Kingdom of Great Britain and Northern Ireland", "GB", "GBR", "826", "United Kingdom of Great Britain and Northern Ireland"),
    ...
    Country("Venezuela, Bolivarian Republic of", "VE", "VEN", "862", "Venezuela, Bolivarian Republic of"),
